...
end, {description = "Play/Resume music on Spotify", group = "Multimedia"}),
                                   awful.key({}, "XF86AudioNext", function()
    -- awful.util.spawn_with_shell(
    -- "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next"
    -- )
    awful.util.spawn_with_shell("playerctl next")
end, {description = "Next music on Spotify", group = "Multimedia"}),
                                   awful.key({}, "XF86AudioPrev", function()
    -- awful.util.spawn_with_shell(
    -- "dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous"
    -- )
    awful.util.spawn_with_shell("playerctl previous")
end, {description = "Previous music on Spotify", group = "Multimedia"}),
-- Volume control
...
end, {description = "launch VS Code", group = "launcher"}),
...
end, {description = "launch multimedia app", group = "launcher"}),
                                   awful.key({modkey}, "c", function()
    awful.spawn(apps.clipboard)
end, {description = "launch clipboard app", group = "launcher"}),
                                   awful.key({modkey}, "e", function()
    awful.spawn(apps.filemanager)
end, {description = "launch filemanager", group = "launcher"}),
                                   awful.key({}, "Print", function()
    awful.spawn.with_shell(apps.screenshot_selection)
end, {description = "capture a screenshot", group = "screenshot"}),
                                   awful.key({"Control"}, "Print", function()
    awful.spawn.with_shell(apps.screenshot_screen)
end, {
...
end, {description = "Put to sleep", group = "system"}),
