...
local brightness_low_icon =
    gears.color.recolor_image(
    gears.surface.load_uncached(
        gears.filesystem.get_configuration_dir() .. "themes/icons/brightness/brightness-low.png"
    ),
    beautiful.fg_dark
)
local brightness_high_icon =
    gears.color.recolor_image(
    gears.surface.load_uncached(
        gears.filesystem.get_configuration_dir() .. "themes/icons/brightness/brightness-high.png"
    ),
    beautiful.fg_dark
)
