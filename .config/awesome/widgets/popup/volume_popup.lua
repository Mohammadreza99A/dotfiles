...
local volume_low_icon = gears.color.recolor_image(
                            gears.surface.load_uncached(gears.filesystem
                                                            .get_configuration_dir() ..
                                                            "themes/icons/volume/volume-low.png"),
                            beautiful.fg_dark)
local volume_high_icon = gears.color.recolor_image(
                             gears.surface.load_uncached(gears.filesystem
                                                             .get_configuration_dir() ..
                                                             "themes/icons/volume/volume-high.png"),
                             beautiful.fg_dark)
local volume_off_icon = gears.color.recolor_image(
                            gears.surface.load_uncached(gears.filesystem
                                                            .get_configuration_dir() ..
                                                            "themes/icons/volume/volume-off.png"),
                            beautiful.fg_dark)
...
awesome.connect_signal("popup::volume", function()
