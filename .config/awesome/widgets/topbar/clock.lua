...
local create_clock = function()
    ...
    local time_format = beautiful.markup_text("%I:%M",
                                              beautiful.font_3xlarge_bold)
            ...
            {
                {
                    date_time,
                    {
                        wibox.container.margin(
                            require("widgets.topbar.calendar"), 8, 16, 16, 16),
    ...
    awesome.connect_signal("calendar::show",
                           function() calendar.visible = true end)

    awesome.connect_signal("calendar::hide",
                           function() calendar.visible = false end)
