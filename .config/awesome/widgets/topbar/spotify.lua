...
local function worker(user_args)
    ...
    spotify_widget = wibox.widget {
        ...
        set_status = function(self, is_playing)
            self:get_children_by_id('icon')[1]:set_markup(" " .. (is_playing and play_icon or pause_icon) .. "  ")
        ...
        set_text = function(self, artist, song)
            local artist_to_display = beautiful.widget_text_markup(ellipsize(artist, max_length), beautiful.fg_normal)
            ...
            local title_to_display = beautiful.widget_text_markup(ellipsize(song, max_length), beautiful.fg_normal)
