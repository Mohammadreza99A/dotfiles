...
local get_taglist = function(s)
    ...
    return wibox.container.background(wibox.container.margin(pac_taglist, -20,
                                                             30),
                                      beautiful.bg_normal)
end
